...
public class CreateServiceUseCase {
    ...
    public CreateServiceUseCase(BusinessRepository businessRepository, ServiceOfferingRepository serviceRepository, AuditRecorder auditRecorder, Clock clock) {
    ...
    public ServiceOffering execute(CreateServiceCommand command) {
        ...
        auditRecorder.record(command.requesterId(), business.getId(), AuditAction.CREATE_SERVICE, "ServiceOffering",
                saved.getId(), null);
